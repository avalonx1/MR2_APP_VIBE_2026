      ...
      int draw =Integer.parseInt(request.getParameter("draw")) ;
          ...
          try {
            ...
            try {   
                ...
                sql = "SELECT id, username, first_name, last_name, email, role_name, divisi "
                        + "FROM v_user_matrix ";
...
//                      actText = "<a  id='add_matrix_"+resultSet.getString("id")+"' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i> Matrix Access</a>";
                        actText = "<a  id='edit_"+resultSet.getString("id")+"' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Edit user </a>";
                        ...
                        actText += "      <p class='info-id'> Delete NIK ini : "+resultSet.getString("username")+"</p>  ";
                        actText += "    </div>  ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/user/user_list_modify.jsp', ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/user/user_list_modify_recstat_del.jsp', ";
...
//                        fieldColumnObj.add("employee_id",new JsonPrimitive(((resultSet.getString("employee_id") == null) ? "N/A" : resultSet.getString("employee_id"))));
                        fieldColumnObj.add("email",new JsonPrimitive(((resultSet.getString("email") == null) ? "N/A" : resultSet.getString("email"))));
...
//                        fieldColumnObj.add("spv_fullname",new JsonPrimitive(((resultSet.getString("spv_fullname") == null) ? "N/A" : resultSet.getString("spv_fullname"))));
