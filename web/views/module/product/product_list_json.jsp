      ...
      int draw =Integer.parseInt(request.getParameter("draw")) ;
          ...
          try {
            ...
            try {   
                ...
                sql = "select count(1) as jml from t_product";
...
//                sql = "select id,name,phone,description,address_b,country_b,street_b,city_b,state_b from t_account";
                sql = "select id, name, code, description from t_product";
                ...
                while (resultSet.next()) {
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/product/product_list_modify.jsp', ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/product/product_list_modify_recstat_del.jsp', ";
                        actText += "    data: {id:"+resultSet.getString("id")+"}, ";
                        actText += "    cache:false, ";
                        actText += "    success: function(d) { ";
                        actText += "      ";
                        actText += "    new PNotify({title: 'Action Status',text: 'Data "+resultSet.getString("name")+" "+resultSet.getString("name")+" has been deleted.. ',type: 'success',styling: 'bootstrap3'});  ";
                        actText += "    ";
                        actText += " }, ";
                        actText += " complete: function(){ ";
                        actText += "  ";
