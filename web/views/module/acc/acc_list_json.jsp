      ...
      int draw =Integer.parseInt(request.getParameter("draw")) ;
          ...
          try {
            ...
            try {   
                ...
                sql = "select count(1) as jml from t_account";
                ...
                sql = "select id,name,phone,description,address_s,country_s,street_s,city_s,state_s "
                        + "from v_account_access_user "
                ...
                if(!search.equals("")) {
                    ...
                    sql += "or lower(address_s) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(description) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(country_s) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(street_s) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(city_s) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(state_s) like('%"+search.toLowerCase()+"%') )";
                 }
...
//                System.out.println(sql);
                ...
                while (resultSet.next()) {
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/acc/acc_list_modify.jsp', ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/acc/acc_list_modify_recstat_del.jsp', ";
                        actText += "    data: {id:"+resultSet.getString("id")+"}, ";
                        actText += "    cache:false, ";
                        actText += "    success: function(d) { ";
                        actText += "      ";
                        actText += "    new PNotify({title: 'Action Status',text: 'Data "+resultSet.getString("name")+" has been deleted.. ',type: 'success',styling: 'bootstrap3'});  ";
                        actText += "    ";
                        actText += " }, ";
                        actText += " complete: function(){ ";
                        actText += "  ";
                        ...
                        fieldColumnObj.add("phone",new JsonPrimitive(((resultSet.getString("phone") == null) ? "N/A" : resultSet.getString("phone"))));
                        ...
                        fieldColumnObj.add("address_s",new JsonPrimitive(((resultSet.getString("address_s") == null) ? "N/A" : resultSet.getString("address_s"))));
                        fieldColumnObj.add("country_s",new JsonPrimitive( ((resultSet.getString("country_s") == null) ? "N/A" : resultSet.getString("country_s")) ));
                        fieldColumnObj.add("street_s",new JsonPrimitive( ((resultSet.getString("street_s") == null) ? "N/A" : resultSet.getString("street_s")) ));
                        fieldColumnObj.add("city_s",new JsonPrimitive( ((resultSet.getString("city_s") == null) ? "N/A" : resultSet.getString("city_s")) ));
                        fieldColumnObj.add("state_s",new JsonPrimitive( ((resultSet.getString("state_s") == null) ? "N/A" : resultSet.getString("state_s")) ));
