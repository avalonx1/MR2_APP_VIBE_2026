      ...
      int draw =Integer.parseInt(request.getParameter("draw")) ;
          ...
          try {
            ...
            try {   
                ...
                sql = "select count(1) as jml from t_group";
                ...
                sql = "select id, group_code,group_name, group_description, group_type_code||' - '||group_type_name as group_type "
                        + "from v_group";

                if(!search.equals("")) {
                   
                    sql += " where ( lower(group_name) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(group_description) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(group_code) like('%"+search.toLowerCase()+"%') ";
                    sql += "or lower(group_type_code||' '||group_type_name) like('%"+search.toLowerCase()+"%') )";
                ...
                while (resultSet.next()) {
                        ...
                        // = "<a  id='view_"+resultSet.getString("id")+"' class='btn btn-primary btn-xs'><i class='fa fa-folder'></i> View </a>";
                        ...
                        actText += "      <p class='info-id'> Delete Name: "+resultSet.getString("group_name")+"</p>  ";
                        actText += "    </div>  ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/group/group_list_modify.jsp', ";
                        ...
                        actText += " $.ajax({  ";
                        actText += "    type: 'POST', ";
                        actText += "    url: 'module/group/group_list_modify_recstat_del.jsp', ";
                        ...
                        actText += " complete: function(){ ";
                        actText += "  ";
                        actText += "    new PNotify({title: 'Action Status',text: 'Data "+resultSet.getString("group_name")+" "+resultSet.getString("group_name")+" has been deleted.. ',type: 'success',styling: 'bootstrap3'});  ";
                        actText += "  ";
                        ...
                        fieldColumnObj.add("group_description",new JsonPrimitive(((resultSet.getString("group_description") == null) ? "N/A" : resultSet.getString("group_description"))));
