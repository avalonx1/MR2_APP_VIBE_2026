...
<html lang="en">
  <head>
    ...
    <!-- Datatables -->
    <link href="../vendors/datatables.net-bs/css/dataTables2.bootstrap.min.css" rel="stylesheet">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span><%=v_appNameURL%></span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Gumilar
                    ...
                    <div class="x_content">
                      ...
                      <div class="">
                        <ul class="to_do">
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Briefing Pagi</p>
                          </li>
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Bertemu dengan Leads</p>
                          </li>
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Telp asisten Suhendar jam 1 siang</p>
                          </li>
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Meetup team di HO jam 12 Siang</p>
                          </li>
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> Laporan Produk di rapihkan </p>
                          </li>
                        </ul>
                      </div>
                    </div>
